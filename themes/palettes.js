export default {
  App: {
    background90Opacity: 'rgba(0, 15, 82, 0.85)',
    'Background 90 Opacity': 'rgba(0, 15, 82, 0.85)',
    custom_rgb_0_0_0: 'rgb(0, 0, 0)',
    'Custom Color 2': 'rgb(0, 0, 0)',
    black: 'rgb(0, 0, 0)',
    Black: 'rgb(0, 0, 0)',
    goldBox: 'rgb(254, 216, 8)',
    'Gold Box': 'rgb(254, 216, 8)',
    custom_rgb_21_34_87: 'rgb(21, 34, 87)',
    'Custom Color 3': 'rgb(21, 34, 87)',
    blackAlpha50: 'rgba(0, 0, 0, 0.5)',
    Black_Alpha_50: 'rgba(0, 0, 0, 0.5)',
    blackAlpha25: 'rgba(0, 0, 0, 0.25)',
    Black_Alpha_25: 'rgba(0, 0, 0, 0.25)',
    progressCardGradient1: 'rgba(21, 37, 117, 0.3)',
    'Progress Card Gradient 1': 'rgba(21, 37, 117, 0.3)',
    progressCardGradient2: 'rgba(73, 88, 163, 0.3)',
    'Progress Card Gradient 2': 'rgba(73, 88, 163, 0.3)',
    advanceCard: 'rgb(29, 31, 30)',
    'Advance Card': 'rgb(29, 31, 30)',
    custom_rgb_255_165_0: 'rgb(255, 165, 0)',
    'Custom Color 4': 'rgb(255, 165, 0)',
    ...
    background2: 'rgb(0, 15, 82)',
    'Background 2': 'rgb(0, 15, 82)',
    custom_rgb_124_252_0: 'rgb(124, 252, 0)',
    'Custom Color_3': 'rgb(124, 252, 0)',
    custom_rgb_73_151_161: 'rgb(73, 151, 161)',
    'Custom Color_7': 'rgb(73, 151, 161)',
    darkCornflowerBlue: 'rgb(36, 55, 147)',
    'Dark Cornflower Blue': 'rgb(36, 55, 147)',
    blackAlpha80: 'rgba(0, 0, 0, 0.8)',
    Black_Alpha_80: 'rgba(0, 0, 0, 0.8)',
    overlay: 'rgba(0, 0, 0, 0.4)',
    Overlay: 'rgba(0, 0, 0, 0.4)',
    resolutionBlue: 'rgb(1, 41, 139)',
    'Resolution Blue': 'rgb(1, 41, 139)',
    custom_rgb_144_238_144: 'rgb(144, 238, 144)',
    'Custom Color_4': 'rgb(144, 238, 144)',
    avi: 'rgba(124, 172, 211, 0.7)',
    Avi: 'rgba(124, 172, 211, 0.7)',
    custom_rgb_0_128_0: 'rgb(0, 128, 0)',
    'Custom Color_2': 'rgb(0, 128, 0)',
    custom_rgb_2_119_217: 'rgb(2, 119, 217)',
    'Custom Color_5': 'rgb(2, 119, 217)',
    custom_rgb_255_255_0: 'rgb(255, 255, 0)',
    'Custom Color_6': 'rgb(255, 255, 0)',
    trueBlue: 'rgb(1, 119, 217)',
    'True Blue': 'rgb(1, 119, 217)',
    background3: 'rgb(0, 15, 82)',
    'Background 3': 'rgb(0, 15, 82)',
    ...
    Success: 'rgb(39, 174, 96)',
    custom_rgb_1_119_217: 'rgb(1, 119, 217)',
    'Custom Color_11': 'rgb(1, 119, 217)',
    lawrencium3: 'rgb(36, 36, 62)',
    'Lawrencium 3': 'rgb(36, 36, 62)',
    ...
    lawrencium1: 'rgb(15, 12, 41)',
    'Lawrencium 1': 'rgb(15, 12, 41)',
    ...
    custom_rgb_51_185_150: 'rgb(51, 185, 150)',
    'Custom Color_8': 'rgb(51, 185, 150)',
    lawrencium2: 'rgb(48, 43, 99)',
    'Lawrencium 2': 'rgb(48, 43, 99)',
    ...
    dashboardBackground: 'rgba(19, 15, 64, 0.75)',
    'Dashboard Background': 'rgba(19, 15, 64, 0.75)',
    purchaseButton: 'rgb(103, 211, 243)',
    'Purchase Button': 'rgb(103, 211, 243)',
    studilyWhiteShade1: 'rgb(227, 231, 249)',
    Studily_White_Shade_1: 'rgb(227, 231, 249)',
    custom_rgb_255_223_0: 'rgb(255, 223, 0)',
    'Custom Color_9': 'rgb(255, 223, 0)',
    ...
    appButtonsColor: 'rgb(92, 180, 243)',
    'App Buttons Color': 'rgb(92, 180, 243)',
    studilyGrayMachine: 'rgb(133, 141, 152)',
    Studily_Gray_Machine: 'rgb(133, 141, 152)',
    custom_rgb_255_106_132: 'rgb(255, 106, 132)',
    'Custom Color_10': 'rgb(255, 106, 132)',
  ...
  Brand: {
    baseBlue: 'rgb(1, 119, 217)',
    'Base Blue': 'rgb(1, 119, 217)',
    red1: 'rgb(210, 20, 4)',
    'Red 1': 'rgb(210, 20, 4)',
    red2: 'rgb(185, 14, 10)',
    'Red 2': 'rgb(185, 14, 10)',
    ...
    White_Opacity: 'rgba(255, 255, 255, 0.15)',
    ...
    darkBlue: 'rgb(12, 26, 51)',
    Dark_Blue: 'rgb(12, 26, 51)',
  },
  Slate: {
    _50: '#f8fafc',
    50: '#f8fafc',
